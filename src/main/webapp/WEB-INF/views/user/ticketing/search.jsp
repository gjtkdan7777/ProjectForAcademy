				...
				<div class="data-box">
					...
					<div class="data-body">
						<div class="bus-data-head">
							<span class="start-area">출발지</span>
							<span class="start-time">출발시간</span>
							<span class="destination">도착지</span>
							<span class="price">요금</span>
							<span class="seat">잔여석</span>
							<span class="seat">총좌석</span>
						...
						<div class="bus-data-body">
							...
							<div class="bus">
								...
								<span class="seat">${li.remaining_seats}</span>
								<span class="seat">${li.total_seats}</span>
								<span class="blank"><a href="seat?bus_name=${li.bus_name}">선택 ></a></span>
							</div>
							</c:forEach>
							<!-- // bus -->
						</div>
