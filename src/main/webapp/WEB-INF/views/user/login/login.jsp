...
<form action="login" method="get">
						...
						<div class="login-form-box">
							<div class="input-warp">
								<div class="input-box">
									...
									<input type="text" id="email" name="email" value="${vo.email}" placeholder="아이디를 입력하세요"/>
								</div>
								<div class="input-box">
				...
				<div class="join-box">
					<div class="sub-box">
						...
						<a href="joinf"><img src="../resources/user/images/login/ico_joinUs_s.png" alt="join" title="join"/>통합회원가입</a>
					</div>
				</div>
				<!-- // join-box -->
			</div>
